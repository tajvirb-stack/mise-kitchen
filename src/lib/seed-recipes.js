...
//   - Air fryer alternative (calibrated for Cuisinart Convection: −15°F, −15% time, AIR FRY mode, middle rack)
...
export const SEED_RECIPES = [
  ...
  // ==========================================================================
  {
    ...
    steps: [
      ...
      { id:'hf001_s2', phase:'cook', timerSec:900,
        text:'Pour in 1¼ cups water and ¼ tsp kosher salt. Bring to a rolling boil, then cover and reduce heat to LOW. Cook 15 minutes until water is fully absorbed and rice is tender. Remove from heat, keep covered, rest 5 min before fluffing.' ,
  ...
  // ==========================================================================
  {
    ...
    image: '🍗',
    ingredients: [
      { id:'hf002_1', qty:2, unit:'unit', name:'boneless skinless chicken breasts (~6 oz / 170g each)', protein:true },
      { id:'hf002_2', qty:1, unit:'unit', name:'can chickpeas (14 oz / 400g), drained and rinsed' },
    ...
    steps: [
      { id:'hf002_s1', phase:'prep', timerSec:null,
        text:'Preheat oven to 450°F with rack in the middle position. Halve zucchini lengthwise, then cut into ½-inch half-moons. Core bell pepper and cut into 1-inch pieces. Mince garlic (or measure paste). Pick parsley leaves and chop fine — you should have about 2 tbsp.' },
      { id:'hf002_s2', phase:'cook', timerSec:900,
        text:'On a half sheet pan: toss zucchini and bell pepper with 1 tbsp olive oil, ½ tsp kosher salt, and ¼ tsp pepper. Spread in a single layer. Roast in middle of oven 12-15 minutes, flipping once at the 8-minute mark, until edges are browned and a piece pierces easily with a fork.',
        airFryerAlt: { text:'Set Cuisinart air fryer to AIR FRY mode at 435°F (oven was 450°F, drop 15°F). Toss zucchini and bell pepper with 1 tbsp olive oil, ½ tsp kosher salt, ¼ tsp pepper. Arrange in single layer on the wire/perforated tray (use the AirFryer basket setup). Air fry 10-12 minutes, shaking tray at 6 minutes, until edges are browned.', timerSec:660 } ,
  ...
  // ==========================================================================
  {
    ...
    image: '🍋',
    ingredients: [
      { id:'hf003_1', qty:2, unit:'unit', name:'boneless skinless chicken breasts (~6 oz each)', protein:true },
    ...
    steps: [
      { id:'hf003_s1', phase:'cook', timerSec:1500,
        text:'Preheat oven to 425°F with rack in the middle. In a 2-quart pot, combine the rice + 1½ cups water + ¼ tsp kosher salt + ¾ tsp of the Golden Turmeric blend (save the rest). Bring to a rolling boil, then reduce heat to LOW, cover, and cook 22-25 min (for brown rice) or 15 min (jasmine) until water is absorbed.' ,
        parallelTask:'While rice cooks: do all the prep below (chop veg, slice protein, make sauces). 15 minutes is enough to get everything ready.'},
      { id:'hf003_s2', phase:'prep', timerSec:null,
        text:'Pat chicken dry with paper towels. In a bowl, toss with ½ tbsp olive oil + remaining ¾ tsp Golden Turmeric + the 1 tbsp Mexican seasoning + ½ tsp kosher salt + ¼ tsp pepper + half the minced garlic. Rub the spice mixture in evenly with your hands. Core and slice bell pepper into ½-inch strips. Halve zucchini and cut into ½-inch half-moons.' },
      { id:'hf003_s3', phase:'cook', timerSec:600,
        text:'Heat a 12-inch oven-safe skillet over medium-high with 1 tbsp olive oil. Sear chicken smooth-side-down undisturbed 4 min until a deep golden crust forms. Flip, sear 1 min. Transfer skillet to oven, roast 5-7 min until thermometer reads 165°F internal. Rest 5 min on cutting board.',
        airFryerAlt: { text:'Skip stovetop sear. Place seasoned chicken on Cuisinart air fryer wire rack. Set to AIR FRY at 385°F. Cook 14-18 min, flipping at 8 min, until internal temp reads 165°F. Rest 5 min on cutting board before slicing.', timerSec:1080 } ,
        parallelTask:"While the oven works: prep all remaining ingredients so you're ready to plate the moment it's done."},
  ...
  // ==========================================================================
  {
    ...
    steps: [
      { id:'hf004_s1', phase:'cook', timerSec:900,
        text:'In a 2-quart pot, bring 1¼ cups water + ¼ tsp salt to a boil. Add rice, stir once, reduce to LOW, cover, and cook 15 min. Remove from heat, keep covered, rest 5 min.' ,
      ...
      { id:'hf004_s4', phase:'cook', timerSec:240,
        ...
        airFryerAlt: { text:'Pat salmon very dry. Season both sides with ¼ tsp salt each + pepper. Brush flesh side with 1 tsp neutral oil. Place skin-side-down on Cuisinart wire rack. AIR FRY at 385°F for 8-10 min total — no flipping needed; salmon is done when it flakes with a fork and the skin is crisp. Use the wire/perforated tray for airflow under the fillet.', timerSec:540 } },
      { id:'hf004_s5', phase:'cook', timerSec:150,
        text:'Flip salmon flesh-side-down. Brush the now-up-facing skin with the 1 tbsp chili-garlic sauce. Cook 2-3 more minutes — salmon is done when it flakes easily with a fork and internal temp reads 125°F (medium) or 145°F (well done). Tip: thin fillets cook faster; check at 2 min.' },
  ...
  // ==========================================================================
  {
    ...
    ingredients: [
      ...
      { id:'hf005_2', qty:1, unit:'unit', name:'large russet potato (~12 oz)' },
    ...
    steps: [
      { id:'hf005_s1', phase:'prep', timerSec:null,
        text:'Preheat oven to 425°F with rack in the middle. Scrub potato (skin on), cut into ¾-inch cubes. Core and slice bell pepper into ½-inch strips. Slice red onion into ½-inch wedges. Finely chop cilantro — about 2 tbsp.' },
      { id:'hf005_s2', phase:'cook', timerSec:1800,
        text:'On a half sheet pan: toss potato + bell pepper + red onion with 2 tbsp olive oil + ¾ tbsp of the Chili-Cumin blend + ¾ tsp kosher salt + ¼ tsp pepper. Spread in a single layer. Roast 28-30 min, flipping with a spatula at the 15-min mark. Vegetables should be deeply browned with crispy edges and a fork pierces potato easily.',
        airFryerAlt: { text:'Set Cuisinart AIR FRY mode at 410°F. Toss vegetables with 2 tbsp olive oil + ¾ tbsp Chili-Cumin blend + ¾ tsp salt + ¼ tsp pepper. Spread on the wire/perforated tray in single layer. Cook 22-25 min, shaking tray at 12 min, until deeply browned. The fan circulates better than oven — check earlier.', timerSec:1380 } ,
        parallelTask:"While the oven works: prep all remaining ingredients so you're ready to plate the moment it's done."},
      ...
      { id:'hf005_s4', phase:'cook', timerSec:1500,
        text:'Place chicken thighs on a separate small sheet pan (or push vegetables to one side of the same pan if it fits). Roast in the same 425°F oven 23-25 min until thermometer in thickest part reads 165°F. Chicken thighs are forgiving — a little extra time only makes them juicier.',
        airFryerAlt: { text:'Place chicken thighs on the Cuisinart wire rack (clean from veg). AIR FRY at 410°F for 17-20 min, flipping at 10 min, until internal temp reads 165°F. Thighs are forgiving — they stay juicy even at 175°F.', timerSec:1080 } ,
        parallelTask:"While the oven works: prep all remaining ingredients so you're ready to plate the moment it's done."},
      { id:'hf005_s5', phase:'cook', timerSec:120,
        text:'Final 2 minutes: switch oven to BROIL. Watch closely through the window — pull as soon as the chicken tops are charred in spots (90-150 seconds). This adds smoky depth. If using air fryer, this step is unnecessary — air fryer already chars the surface.',
  ...
  // ==========================================================================
  {
    ...
    steps: [
      { id:'hf006_s1', phase:'cook', timerSec:900,
        text:'In a 2-quart pot, bring 1¼ cups water + 1 tsp Better Than Bouillon (whisk to dissolve) to a boil. Add rice, stir once, reduce to LOW, cover, cook 15 min. Off heat, stir in the frozen edamame + ½ tbsp sesame seeds. Cover, rest 5 min (residual heat thaws edamame).' ,
        parallelTask:"While rice cooks: do all the prep below (chop veg, slice protein, make sauces) so you're ready to cook the moment it's done."},
  ...
  // ==========================================================================
  {
    ...
    steps: [
      ...
      { id:'hf007_s3', phase:'cook', timerSec:300,
        text:'Add the 2 tbsp tomato paste. Stir constantly 60 seconds until it darkens to brick red (this kills the raw tomato taste). Add the diced tomato + ¾ cup water + ½ tsp sugar + ¼ tsp kosher salt + ¼ tsp pepper. Bring to a simmer, then cook 4 minutes until tomatoes break down.' },
      ...
      { id:'hf007_s5', phase:'cook', timerSec:480,
        text:'Pat salmon very dry. Season with ½ tsp kosher salt + ¼ tsp pepper. Nestle salmon SKIN-SIDE-DOWN into the simmering tagine, pushing it down so the liquid comes ⅔ up the sides of the fillet. Cover. Reduce heat to medium-low. Cook 6-8 min — salmon is done when it flakes easily and internal temp reads 125°F (medium) or 145°F (well done). Don\'t flip; the steam under the lid cooks the top.' ,
  ...
  // ==========================================================================
  {
    ...
    image: '🥗',
    ingredients: [
      { id:'hf008_1', qty:2, unit:'unit', name:'boneless skinless chicken breasts (~6 oz each)', protein:true },
    ...
    steps: [
      { id:'hf008_s1', phase:'cook', timerSec:1200,
        text:'In a 2-quart pot, bring 1¼ cups water + 1 tsp Better Than Bouillon chicken base + ½ tbsp butter to a boil. Add rice, stir once, reduce to LOW, cover, cook 18-20 min. Off heat, rest 5 min. Fluff with fork.' ,
        parallelTask:'While rice cooks: do all the prep below (chop veg, slice protein, make sauces). 15 minutes is enough to get everything ready.'},
      ...
      { id:'hf008_s5', phase:'prep', timerSec:null,
        text:'Pat chicken very dry. Season both sides evenly with the 1 tbsp Zesty Garlic blend + ¼ tsp additional kosher salt + ⅛ tsp pepper. Rub the seasoning in firmly.' },
      { id:'hf008_s6', phase:'cook', timerSec:540,
        text:'Heat a 12-inch non-stick skillet over medium-high with 1 tbsp olive oil. When oil shimmers, place chicken smooth-side-down. Sear undisturbed 4-5 min until deep golden crust forms. Flip, reduce heat to MEDIUM, cook 4-5 more min until thermometer reads 165°F. Rest on cutting board 5 min, then slice on the bias into ½-inch slices.',
        airFryerAlt: { text:'Brush seasoned chicken with 1 tsp olive oil. Place on Cuisinart wire rack. AIR FRY at 385°F for 14-18 min, flipping at 8 min, until internal temp reads 165°F. Rest 5 min before slicing.', timerSec:1080 } },
  ...
  // ==========================================================================
  {
    ...
    image: '🍛',
    ingredients: [
      { id:'hf009_1', qty:2, unit:'unit', name:'boneless skinless chicken breasts (~6 oz each)', protein:true },
      ...
      { id:'hf009_5', qty:2, unit:'cup', name:'baby spinach (~2 oz / 60g, loosely packed)' },
    ...
    steps: [
      ...
      { id:'hf009_s3', phase:'cook', timerSec:360,
        text:'Heat a 12-inch non-stick skillet over medium-high with 1 tbsp neutral oil. Pat chicken dry, season with ½ tsp kosher salt + ¼ tsp pepper. Add chicken in single layer (don\'t overcrowd; cook in 2 batches if needed). Sear undisturbed 3 min, then stir and cook 3 more min until golden and just cooked through (internal temp 165°F). Transfer to a plate.',
        airFryerAlt: { text:'Toss cubed chicken with 1 tbsp neutral oil + ½ tsp salt + ¼ tsp pepper. Spread on Cuisinart wire rack in a single layer. AIR FRY at 410°F for 8-10 min, shaking at 5 min, until internal temp reads 165°F. Transfer to a plate.', timerSec:540 } },
  ...
  // ==========================================================================
  {
    ...
    steps: [
      { id:'hf010_s1', phase:'cook', timerSec:1500,
        text:'Preheat oven to 450°F with rack in the middle. Cube potatoes (skin on) into ½-inch pieces. On a half sheet pan: toss with 1 tbsp olive oil + ¾ tsp kosher salt + ¼ tsp pepper. Spread in single layer. Roast 22-25 min, flipping with a spatula at 12 min, until deeply golden and crispy on the outside.',
        airFryerAlt: { text:'Set Cuisinart AIR FRY at 435°F. Toss potatoes with 1 tbsp olive oil + ¾ tsp salt + ¼ tsp pepper. Spread on wire/perforated tray in single layer. AIR FRY 18-20 min, shaking tray at 10 min, until crispy outside and tender inside.', timerSec:1140 } ,
        parallelTask:"While the oven works: prep all remaining ingredients so you're ready to plate the moment it's done."},
  ...
  // ==========================================================================
  {
    ...
    image: '🥔',
    ingredients: [
      { id:'hf011_1', qty:2, unit:'unit', name:'boneless skinless chicken breasts (~6 oz each)', protein:true },
    ...
    steps: [
      { id:'hf011_s1', phase:'cook', timerSec:1500,
        text:'Preheat oven to 450°F with rack in the middle. Scrub potatoes, cut into wedges (cut potato in half lengthwise, then each half into 4 long wedges = 8 per potato). On a half sheet pan: toss with 1 tbsp olive oil + ½ tsp garlic salt + ¼ tsp pepper. Spread in single layer, cut-sides down. Roast 25 min, flipping at 12 min, until deeply golden and crispy.',
        airFryerAlt: { text:'Set Cuisinart AIR FRY at 435°F. Toss wedges with 1 tbsp olive oil + ½ tsp garlic salt + ¼ tsp pepper. Arrange on wire/perforated tray cut-side-down in single layer. AIR FRY 20-22 min, shaking at 10 min, until crispy.', timerSec:1260 } ,
        parallelTask:"While the oven works: prep all remaining ingredients so you're ready to plate the moment it's done."},
      ...
      { id:'hf011_s3', phase:'prep', timerSec:null,
        text:'Pat chicken very dry with paper towels. Rub all over with 1 tsp olive oil. Then evenly coat with the entire 1 tbsp Applewood Smoke blend + ¼ tsp additional kosher salt + ⅛ tsp pepper. Use your hands to press the rub firmly into the meat.' },
      { id:'hf011_s4', phase:'cook', timerSec:600,
        text:'Heat a 12-inch oven-safe skillet over medium-high with 1 tbsp olive oil. When oil shimmers, place chicken smooth-side-down. Sear undisturbed 4-5 min until a deep dark crust forms (the brown sugar in the rub helps caramelize). Flip and cook 4-5 min until internal temp reads 165°F. Rest 5 min on cutting board.',
        airFryerAlt: { text:'Brush rubbed chicken with 1 tsp neutral oil. Place on Cuisinart wire rack. AIR FRY at 385°F for 14-18 min, flipping at 8 min, until internal temp reads 165°F. The brown sugar in the rub may darken quickly — that\'s desired flavor. Rest 5 min before slicing.', timerSec:1080 } },
  ...
  // ==========================================================================
  {
    ...
    steps: [
      ...
      { id:'hf012_s4', phase:'cook', timerSec:720,
        text:'Heat a 12-inch non-stick skillet over medium-high with 1 tbsp neutral oil. Remove chicken from marinade (let excess drip off). Add to skillet smooth-side-down. Sear undisturbed 5-6 min until deeply caramelized (the sugar in the marinade browns fast). Flip, cook 5-6 more min until internal temp reads 165°F. Rest on cutting board 5 min, then slice into ½-inch strips against the grain.',
        airFryerAlt: { text:'Place marinated thighs (let excess drip off) on Cuisinart wire rack. AIR FRY at 410°F for 14-18 min, flipping at 8 min. Internal temp should read 165°F. The marinade sugars caramelize beautifully. Rest 5 min, then slice.', timerSec:1080 } },
  ...
  // ==========================================================================
  {
    ...
    steps: [
      { id:'hf013_s1', phase:'cook', timerSec:900,
        text:'Grate half the ginger (about 1½ tsp). In a 2-quart pot, bring 1¼ cups water + grated ginger + ¼ tsp salt to a boil. Add rice, stir once, reduce to LOW, cover, cook 15 min. Off heat, rest 5 min covered.',
        pasteAlt: { text:'In a 2-quart pot, bring 1¼ cups water + ½ tbsp ginger paste + ¼ tsp salt to a boil. Add rice, stir once, reduce to LOW, cover, cook 15 min. Off heat, rest 5 min covered.', timerSec:900 } ,
        parallelTask:'While rice cooks: do all the prep below (chop veg, slice protein, make sauces). 15 minutes is enough to get everything ready.'},
  ...
  // ==========================================================================
  {
    ...
    steps: [
      { id:'hf014_s1', phase:'cook', timerSec:240,
        text:'In a 3-quart saucepan, melt 1 tbsp butter over medium heat. Add the finely diced carrot. Cook 3-4 min until softened.' },
      ...
      { id:'hf014_s4', phase:'cook', timerSec:240,
        ...
        airFryerAlt: { text:'Pat salmon dry, season as above, brush flesh side with 2 tbsp mango chutney. Place skin-side-down on Cuisinart wire rack. AIR FRY at 385°F for 9-11 min total — no flipping. Salmon is done when it flakes easily. The chutney glaze will caramelize on the surface.', timerSec:600 } },
      { id:'hf014_s5', phase:'cook', timerSec:180,
        text:'Flip salmon flesh-side-down. Brush the now-up-facing skin with another ½ tbsp mango chutney. Cook 2-3 more min until salmon flakes easily and internal temp reads 125°F (medium) or 145°F (well done).' },
  ...
  // ==========================================================================
  {
    ...
    steps: [
      { id:'hf015_s1', phase:'cook', timerSec:900,
        text:'In a 2-quart pot, bring 1¼ cups water + half the ginger-garlic puree + 1 tbsp butter + ¼ tsp salt to a boil. Add rice, stir once, reduce to LOW, cover, cook 15 min. Off heat, stir in ½ tbsp black sesame seeds. Rest 5 min covered.',
        pasteAlt: { text:'In a 2-quart pot, bring 1¼ cups water + 1 tbsp ginger-garlic paste + 1 tbsp butter + ¼ tsp salt to a boil. Add rice, stir once, reduce to LOW, cover, cook 15 min. Off heat, stir in ½ tbsp sesame seeds.', timerSec:900 } ,
        parallelTask:"While rice cooks: do all the prep below (chop veg, slice protein, make sauces) so you're ready to cook the moment it's done."},
      ...
      { id:'hf015_s5', phase:'cook', timerSec:480,
        text:'Pat salmon very dry. Season skin side with ¼ tsp salt; flesh side with ¼ tsp salt + ⅛ tsp pepper. Heat a 12-inch non-stick skillet over medium-high with 1 tbsp neutral oil. When oil shimmers, place salmon SKIN-SIDE-DOWN, press gently for first 20 seconds. Cook 4 min undisturbed. Flip, brush the skin generously with most of the Bang Bang sauce (save 2 tbsp). Cook 2-3 more min until salmon flakes and internal temp reads 125°F (medium) or 145°F (well done).',
        airFryerAlt: { text:'Pat dry, season as above. Place skin-side-down on Cuisinart wire rack. AIR FRY at 385°F for 6 min, then brush top generously with Bang Bang sauce. Continue cooking 4-5 more min until salmon flakes. Saves you wiping the pan.', timerSec:600 } },
  ...
  // ==========================================================================
  {
    ...
    steps: [
      { id:'hf016_s1', phase:'prep', timerSec:null,
        text:'Preheat oven to 450°F with rack in upper-middle position. Core bell pepper and slice into thin strips (⅛-¼ inch). Thinly slice green onions on a diagonal — about 3 tbsp.' },
      ...
      { id:'hf016_s5', phase:'cook', timerSec:540,
        text:'Bake in oven 8-10 min until cheese is bubbly with brown spots and flatbread edges are golden-crispy. (If flatbreads are getting too dark before cheese melts, drop oven to 425°F.)',
        airFryerAlt: { text:'Set Cuisinart AIR FRY at 410°F. Place 1 topped flatbread on the rack (likely won\'t fit both at once — bake in 2 rounds, OR use bake mode for both). AIR FRY 6-8 min until cheese is bubbly and edges crisp. Repeat for second flatbread (keeps the first warm under foil).', timerSec:480 } },
  ...
  // ==========================================================================
  {
    ...
    steps: [
      { id:'hf017_s1', phase:'cook', timerSec:600,
        text:'Bring a large pot of water to a rolling boil. Salt generously (1 tbsp kosher salt per 4 quarts). Add linguine. Cook according to package timing minus 1 minute (al dente). Before draining, RESERVE 1 cup of pasta water. Drain pasta.' ,
        parallelTask:'While noodles cook: prep all ingredients for the sauce/topping so you can toss everything together immediately.'},
  ...
  // ==========================================================================
  {
    ...
    steps: [
      { id:'hf018_s1', phase:'cook', timerSec:840,
        text:'Preheat oven to 425°F with rack in the middle. In a 2-quart pot, bring 1¾ cups water + ½ tsp salt to a boil. Add couscous, stir, and reduce to medium. Simmer uncovered 12-14 min until tender (taste a piece). Drain in a colander.' ,
        parallelTask:"While the oven works: prep all remaining ingredients so you're ready to plate the moment it's done."},
      ...
      { id:'hf018_s4', phase:'cook', timerSec:780,
        text:'Place salmon skin-down on a parchment-lined sheet pan. Roast 11-13 min — salmon is done when it flakes easily and internal temp reads 125°F (medium) or 145°F (well done). The pesto will form a herby crust.',
        airFryerAlt: { text:'Place pesto-brushed salmon skin-down on Cuisinart wire rack. AIR FRY at 410°F for 8-10 min total — no flipping. The pesto crust crisps beautifully. Salmon is done when it flakes.', timerSec:540 } ,
  ...
  // ==========================================================================
  {
    ...
    image: '🍯',
    ingredients: [
      { id:'hf020_1', qty:2, unit:'unit', name:'boneless skinless chicken breasts (~6 oz each)', protein:true },
    ...
    steps: [
      { id:'hf020_s1', phase:'cook', timerSec:900,
        text:'In a 2-quart pot, bring 1¼ cups water + ¼ tsp salt to a boil. Add rice, stir once, reduce to LOW, cover, cook 15 min. Off heat, rest 5 min covered.' ,
        parallelTask:"While rice cooks: do all the prep below (chop veg, slice protein, make sauces) so you're ready to cook the moment it's done."},
      { id:'hf020_s2', phase:'cook', timerSec:1080,
        text:'Preheat oven to 425°F with rack in the middle. Cut broccoli into 1-inch florets. Slice carrots into ¼-inch coins on a diagonal. On a half sheet pan: toss with 1 tbsp olive oil + ½ tsp kosher salt + ¼ tsp pepper. Spread in single layer. Roast 18-20 min, flipping at 10 min, until edges are charred and a fork pierces carrot easily.',
        airFryerAlt: { text:'Set Cuisinart AIR FRY at 410°F. Toss broccoli florets and carrot coins with 1 tbsp olive oil + ½ tsp salt + ¼ tsp pepper. Spread on wire/perforated tray in single layer. AIR FRY 14-16 min, shaking at 8 min, until edges char and carrots are tender.', timerSec:900 } ,
        parallelTask:'While the oven works: prep the rest of the ingredients (chop, slice, make sauces). 15 minutes is enough for all prep.'},
...

  {
    ...
    steps: [
      ...
      { id:'bf003_s3', phase:'plate', timerSec:null,
        text:'Eat immediately. Batch tip: Sunday hard-boil 6-8 eggs (in the air fryer at 270°F for 16 min, then ice bath) for a week of fast assembly.' }
    ]
  },
...

  {
    ...
    steps: [
      ...
      { id:'bf005_s5', phase:'plate', timerSec:90,
        text:'Reheat from frozen: microwave 60-90 sec, OR air fryer at 350°F for 3 min. Serve 2 pancakes per breakfast topped with Greek yogurt, berries, or a drizzle of hot honey.' }
    ]
  },
...

  {
    ...
    steps: [
      { id:'lw001_s1', phase:'cook', timerSec:600,
        text:'Air fry hash brown at 400°F for 10 min (no flip needed), or skillet over medium-high heat 4 min per side. Should be deep golden with crispy edges.' },
...

  {
    ...
    steps: [
      ...
      { id:'lw002_s2', phase:'cook', timerSec:600,
        text:'Air fry hash brown at 400°F for 10 min until golden and crispy.' },
...

  {
    ...
    steps: [
      { id:'lw003_s1', phase:'cook', timerSec:600,
        text:'Air fry hash brown at 400°F for 10 min. Cook 3 strips turkey bacon in a non-stick skillet over MEDIUM heat 2-3 min per side. Set both aside.' },
...

  {
    ...
    steps: [
      { id:'lw004_s1', phase:'cook', timerSec:600,
        text:'Air fry hash brown at 400°F for 10 min. Cook 3 strips turkey bacon over MEDIUM 2-3 min per side. Slice ½ avocado.' },
...

  {
    ...
    steps: [
      { id:'lw005_s1', phase:'cook', timerSec:600,
        text:'Air fry hash brown at 400°F for 10 min until crispy.' },
...

  {
    ...
    steps: [
      { id:'lw006_s1', phase:'cook', timerSec:600,
        text:'Air fry hash brown at 400°F for 10 min until crispy. Cook 3 strips turkey bacon over MEDIUM 2-3 min per side.' },
...

  {
    ...
    steps: [
      ...
      { id:'lb003_s2', phase:'cook', timerSec:900,
        text:'Air fry at 400°F for 14-16 min, flipping at 8 min. Internal temp should reach 165°F at the thickest part. Let rest 5 min on a cutting board, then slice across the grain.' },
